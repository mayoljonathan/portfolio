  ...
  getFeaturedProjects(): FeaturedProject[] {
    return [
      new FeaturedProject({
        ...
        imageUrl:
          "https://res.cloudinary.com/tsebvaan/image/upload/c_scale,w_1000/v1693924173/inquisilearn_survey_narrow_pof33o.png",
        techStack: [
          "React",
          "NextJS",
          "TailwindCSS",
        ...
        website: "https://inquisilearn.com",
      }),
      new FeaturedProject({
        name: "P-Plus - A Lifestyle You Deserve",
        description:
          "A similar app like Grab that currently includes services such as food delivery and online booking of doctors.",
        imageUrl:
          "https://res.cloudinary.com/tsebvaan/image/upload/c_scale,w_1000/v1591072738/portfolio/pplus.png",
        techStack: ["Flutter", "ScopedModel", "Provider", "MVVM"],
        googlePlayUrl:
          "https://play.google.com/store/apps/details?id=com.primary.pplus",
      }),
      new FeaturedProject({
        name: "P-Plus Driver",
        description:
          "The food delivery driver app for P-Plus accredited merchants.",
        imageUrl:
          "https://res.cloudinary.com/tsebvaan/image/upload/c_scale,w_1000/v1591072738/portfolio/pplus_driver.png",
        techStack: ["Flutter", "ScopedModel", "MVVM"],
      }),
      new FeaturedProject({
        name: "P-Plus Merchant Cashier",
        description:
          "A merchant app that will be used by the cashier to verify vouchers and add loyalty points to customers.",
        imageUrl:
          "https://res.cloudinary.com/tsebvaan/image/upload/c_scale,w_1000/v1591072737/portfolio/pplus_merchant.png",
        techStack: ["Flutter", "ScopedModel", "MVVM"],
      }),
    ];
  }
  ...
  getOtherProjects(): Project[] {
    return [
      ...
      new Project({
        ...
        description:
          'An app that simulates the look for Gameboy Advance SP. This is my entry for <a href="https://flutterhackathon.com" target="_blank" rel="noreferrer noopener">Flutter Hackathon 2020</a>.',
        techStack: ["Flutter", "Provider"],
        website: "https://mayoljonathan.github.io/flutter_gameboy_advance_sp",
        repositoryUrl:
          "https://github.com/mayoljonathan/flutter_gameboy_advance_sp",
      }),
      new Project({
        name: "Jollibee Kiosk",
        ...
        repositoryUrl:
          "https://github.com/mayoljonathan/flutter-jollibee-kiosk",
      }),
      new Project({
        name: "ShowcaseIT",
        description:
          "A place where developers can showcase and distribute their web and mobile apps to other users.",
      ...
      new Project({
        ...
        description:
          "The administrator panel mobile app for ACLC Group Portal.",
        techStack: ["NativeScript", "Angular 4", "Firebase"],
        website:
          "https://mayoljonathan.github.io/portfolio_2018/project/aclc-group-portal-admin",
      }),
      new Project({
        ...
        website:
          "https://mayoljonathan.github.io/portfolio_2018/project/aclc-mobile-class-record",
        repositoryUrl:
          "https://github.com/mayoljonathan/ACLC-Mobile-Class-Record",
      }),
      new Project({
        name: "ACLC Scheduling System",
        description:
          "A web-based scheduling system for ACLC College of Mandaue.",
        techStack: ["PHP", "JQuery", "MySQL", "Bootstrap"],
        website:
          "https://mayoljonathan.github.io/portfolio_2018/project/aclc-scheduling-system",
        repositoryUrl: "https://github.com/mayoljonathan/aclc_scheduling",
      }),
      new Project({
        name: "News PH",
        description:
          "A simple website for getting daily news in the Philippines from different sources.",
      ...
      new Project({
        name: "Portfolio v1",
        description:
          "My portfolio for year 2018 after I graduated from college.",
        techStack: ["Angular 5"],
