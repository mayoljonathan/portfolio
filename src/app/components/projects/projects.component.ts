    ...
    this.featuredProjects = [
      {
        ...
        description: 'A similar app like Grab that currently includes services such as food delivery and online booking of doctors. Built the app from scratch and it was my first application using Flutter!',
      ...
      {
        name: 'P-Plus Driver',
        description: 'The food delivery driver app for P-Plus and it was also built using Flutter.',
